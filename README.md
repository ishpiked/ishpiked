...
Currently building: a Telegram URL monitor/uptime bot on Vercel Cron + Supabase, and a black-and-white movie/series discovery webapp on the TMDB API.
...
| Project | Description |
|---|---|
| [Nomadry](https://github.com/ishpiked/REPLACE_WITH_REPO_NAME) | Multi-bot ecosystem — file-sharing, news-posting, premium subscription tiers |
| [Leon](https://github.com/ishpiked/REPLACE_WITH_REPO_NAME) | AI chatbot on the Groq API with parallel web search |
| [Wholehand](https://github.com/ishpiked/REPLACE_WITH_REPO_NAME) | Anime character guessing/collection bot, AniList GraphQL |
